...
describe("AuthService unit tests", () => {
    ...
    beforeEach(async () => {
        ...
        config = new EnvConfigService(configService)
    ...
    it("should verify a jwt", async () => {
        ...
        await expect(sut.verifyJwt("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMn0.KMUFsIDTnFmyG3nMiGM6H9FNFUROf3wh7SmqJp-QV30")).rejects.toThrow()
    })
})
