import { SearchParams, SearcResult } from "../../searchable-repository-contracts"
...
describe("Searchable Repository unit tests", () => {
    ...
    describe("SearchResultParams tests", () => {
        it("constructor prop", () => {
            let sut = new SearcResult({
                items: ["teste1", "teste2", "teste3", "teste14"] as any,
                total: 4,
                currentPage: 1,
                perPage: 2,
                sort: null,
